...
int num;
void showMenu();
employee emp[max], tempemp[max],						// Array of Employees to store the data in the form of the Structure of the array
sortemp[max], sortemp1[max];
void build()											// Function to build the given datatype
{
...
cout << "Exit (5)\n";
int option;
cin >> option;																// Call function on the basis of the above function
if (option == 1) {
build();
}
else if (option == 2) {
